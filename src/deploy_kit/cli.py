...
def main(backend: str | None, target: str | None):
    ...
    \b
    Examples:
      deploy-kit --compose user@host.example.com   # Compose with SSH target
      deploy-kit --portainer https://portainer.io  # Portainer with URL
